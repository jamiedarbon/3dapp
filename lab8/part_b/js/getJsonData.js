$(document).ready(function(){
	$.getJSON('./model/data.json', function(jsonObj) {
		...
		$('#Coke3DModel').html('<inline url=' + jsonObj.pageTextData[9].Coke3DModel + '></inline>');

		$('#Sprite3DModel').html('<inline url=' + jsonObj.pageTextData[10].Sprite3DModel + '></inline>');

		$('#Pepper3DModel').html('<inline url=' + jsonObj.pageTextData[11].Pepper3DModel + '></inline>');
